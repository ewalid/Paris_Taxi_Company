...
class SecureSchemeHeader(Setting):
    ...
    desc = """\
        ...
        A dictionary containing headers and values that the client proxy
        ...
        names, so make sure they're exactly what your client proxy sends
        when handling HTTPS requests.

        It is important that your client proxy configuration ensures that
